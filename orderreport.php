        ...
        <div class="modal-content">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                <div class="input-group mb-2 mr-sm-2 mb-sm-0" style="color: orange">
                  ...
                  <input type="date" class="form-control" name="date1" id="date1" max='<?=date("Y-m-d")?>' required />
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                <div class="input-group mb-2 mr-sm-2 mb-sm-0" style="color: orange">
                  ...
                  <input type="date" class="form-control" name="date2" id="date2" max='<?=date("Y-m-d")?>' required /> 
                </div>
              </div>
            </div>           
          </div>
          ...
          <div class="modal-footer">
            <div class="row col-sm-12" align="center">
              ...
              <a href="sale_report.php" class="btn btn-danger" role="button" >રદ કરો</a>
            </div>
          </div>
        </div>
      </form>
